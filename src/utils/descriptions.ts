...
interface weatherDescriptionsType {
  [code: number]: {
    day: { description: string; image: ImageSourcePropType; translationKey: string };
    night: { description: string; image: ImageSourcePropType; translationKey: string };
  };
}
...
export function useWeatherDescriptions() {
  ...
  const getTranslatedDescriptions = () => {
